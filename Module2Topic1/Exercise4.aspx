...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="fullName" ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator><br />
        ...
        <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="age" ErrorMessage="Age must be between 0 and 100" Type="Integer" MinimumValue="0" MaximumValue="100"></asp:RangeValidator>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="email" ErrorMessage="Invalid Email" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$"></asp:RegularExpressionValidator>
        ...
        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="email" ControlToValidate="confirmEmail" ErrorMessage="Emails do not match"></asp:CompareValidator>
